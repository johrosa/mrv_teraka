...
class MerginDataMerger:
    ...
    def detect_conflicts(self, original, collected, pk_field='id'):
        ...
        # Entrées modifiées - Optimisé avec un dictionnaire pour passer de O(N*M) à O(N+M)
    ...
    def merge(self, table, original, collected, strategy='merge', pk_field='id'):
        ...
        if strategy == 'merge':
            ...
            # PostgREST supporte l'upsert en batch, ce qui permet de traiter modifs + ajouts en 1 appel
            ...
            # 3. Traiter les suppressions en batch (Optimisé)
            if deleted_ids:
                try:
