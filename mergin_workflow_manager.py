...
class MerginDataMerger:
    ...
    def detect_conflicts(self, original, collected, pk_field='id'):
        ...
        # Entrées modifiées
        # Optimization: Use a dictionary for O(1) lookup of original items
    ...
    def merge(self, table, original, collected, strategy='merge', pk_field='id'):
        ...
        if strategy == 'merge':
            ...
            # Optimization: Combine added and modified records into a single batch UPSERT call.
            ...
            # Optimization: Use the 'in.' operator to delete multiple records in a single API call.
            if deleted_ids:
                try:
                    # PostgREST syntax for batch delete: id=in.(id1,id2,...)
